get_prm_list <- function(param, i, r, t){
  return(list(alpha_r = param$alpha_r[r], pai_1r = param$pai_1r[r], pai_0r = param$pai_0r[r], beta_rt = param$beta_rt[r,t], category_prm = append(0, param$beta_rk[r,])))
}

logit <- function(param, category_prm, x){
  return(param$alpha_r *(x - param$pai_0r - param$pai_1r * param$beta_rt - category_prm))
}
